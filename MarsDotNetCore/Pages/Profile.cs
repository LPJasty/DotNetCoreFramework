...
namespace MarsDotNetCore.Pages
{
    class Profile
    {
        ...
        public void ProfileSteps()
        {
            ...
            //image.SendKeys("C:\Users\Lakshmi Jasti\Documents\Lakshmi.jpg");
            //AutoItX3 auto = new AutoItX3();
            //Thread.Sleep(1000);
            //auto.Send("{ENTER}");//press enter using autoit
            ...
            FirstName.SendKeys(GlobalDefinitions.ExcelOperations.ReadData(1, "FirstName"));//Enter first name in textbox1
            Thread.Sleep(1500);

            lastname.Clear();//Clear last name textbox
            Thread.Sleep(1500);

            lastname.SendKeys(GlobalDefinitions.ExcelOperations.ReadData(1, "LastName"));//Enter last name in textbox 2
            ...
            descbox.Clear();
            Thread.Sleep(1500);
            descbox.SendKeys(GlobalDefinitions.ExcelOperations.ReadData(1, "Desc"));
            Thread.Sleep(1500);
            descsave.Click();
            Thread.Sleep(1500);
            ...
            AddLanguage.SendKeys(GlobalDefinitions.ExcelOperations.ReadData(1, "Language"));
            Thread.Sleep(1500);
            ...
            //Verification
            Thread.Sleep(1000);
            string msg = GlobalDefinitions.ExcelOperations.ReadData(2, "DATA");
